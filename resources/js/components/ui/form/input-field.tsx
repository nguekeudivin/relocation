      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            readOnly={readOnly}
            className={cn(
              "focus:ring-secondary-300 block w-full rounded-lg border border-gray-300 bg-transparent p-2 text-sm text-gray-900 focus:border-transparent focus:ring-2 focus:outline-none",
