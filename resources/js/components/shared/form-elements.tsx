...
import { FileField, FileValue } from "../ui/form/file-field";
  ...
  return (
    <div className="space-y-6">
        ...
        options={[
          {
            label: "Option 1",
            value: "option1",
            description: "This is the description of the option 1",
          },
          {
            label: "Option 2",
            value: "option2",
            description: "This is the description of the option 2",
          },
        ]}
        ...
        options={[
          {
            label: "radio 1",
            value: "radio1",
            description: "This is the description of the radio 1",
          },
          {
            label: "radio 2",
            value: "radio2",
            description: "This is the description of the radio 2",
          },
        ]}
        onCheckedChange={function (
          { label, value, description },
        ...
        options={[
          {
            label: "Chip 1",
            value: "chip1",
            description: "This is the description of the Chip 1",
          },
          {
            label: "Chip 2",
            value: "chip2",
            description: "This is the description of the Chip 2",
          },
        ]}
      ...
      <FileField
        name={`file`}
        id={`file`}
        file={form.getFileValue(`proof`)}
        onFileChange={form.handleFileChange("proof")}
      />
    </div>
  );
}
