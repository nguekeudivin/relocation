    ...
    return (
        <Modal name={name} className="w-[500px]" header={<></>}>
            <div className="flex flex-col items-center text-center">
                ...
                <h3 className="mt-4 text-lg font-semibold">{t('Reject this booking?')}</h3>
                <p className="mt-2 text-sm text-gray-600">
                    {t('You are about to reject this customer booking request. This action cannot be undone.')}
                </p>
                ...
                <div className="mt-6 flex gap-3">
                    ...
                    <Button color="red" onClick={submit} loading={store.loading.status[name]}>
                        {t('Yes, reject booking')}
                    </Button>
                </div>
            </div>
        </Modal>
